...
uint64_t bits2(uint64_t number, uint64_t start, uint64_t end){
...
uint64_t get_adr_target(uint32_t *adrp){
    uint32_t immlo = bits2(*adrp, 29, 30);
    uint32_t immhi = bits2(*adrp, 5, 23);
...
uint64_t get_adrp_add_target(uint32_t *adrpp){
    ...
    return (uint64_t)(addr + (int64_t)bits2(add, 10, 21));
}
...
uint64_t get_adrp_ldr_target(uint32_t *adrpp){
    ...
    uint32_t size = bits2(ldr, 30, 31);
    uint32_t V = bits2(ldr, 26, 26);
    uint32_t opc = bits2(ldr, 22, 23);
    uint32_t imm12 = bits2(ldr, 10, 21);
...
uint64_t get_branch_dst(uint32_t branch, uint32_t *pc){
    ...
    int32_t imm26 = (int32_t)sign_extend(bits2(branch, 0, 25) << 2, 28);
...
uint64_t get_compare_and_branch_dst(uint32_t cab, uint32_t *pc){
    intptr_t signed_pc = (intptr_t)pc;
    int32_t imm19 = (int32_t)sign_extend(bits2(cab, 5, 23) << 2, 21);
...
uint64_t get_cond_branch_dst(uint32_t branch, uint32_t *pc){
    intptr_t signed_pc = (intptr_t)pc;
    int32_t imm19 = (int32_t)sign_extend(bits2(branch, 5, 23) << 2, 21);
...
uint64_t get_test_and_branch_dst(uint32_t tab, uint32_t *pc){
    intptr_t signed_pc = (intptr_t)pc;
    int32_t imm14 = (int32_t)sign_extend(bits2(tab, 5, 18) << 2, 16);
